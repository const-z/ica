...
Управление схемами: Предоставляет методы для загрузки, хранения (in-memory) и удаления графов схем, описываемых в YAML-формате.
...
C4Container
    ...
    Person(expert, "Эксперт", "Загружает YAML схемы")
    ...
    Rel(expert, grpc_api, "Загружает/удаляет схемы (YAML)")
